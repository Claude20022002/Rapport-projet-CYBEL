...
\begin{itemize}
    ...
    servent de base à l'interprétation du module \texttt{move\_base}, replacé
    dans le cadre plus large de l'architecture des robots mobiles de service
    décrite par Siegwart, Nourbakhsh \& Scaramuzza (2011) et par Siciliano \&
    Khatib (2016).
...
Partiel / évolutif \\
\hline
Maturité et robustesse &
Élevée (déployée industriellement) &
Élevée (écosystème ROS établi de longue date) &
Prototype de stage ($\sim$90~\% de fiabilité de connexion \textit{rosbridge}, cf. chapitre 7) \\
\hline
\end{tabular}
...
Ce dernier critère nuance volontairement les précédents : CYBEL répond mieux
aux besoins fonctionnels identifiés au chapitre 2, mais reste, à ce stade,
un prototype de quelques mois de développement, sans le niveau de maturité
et de robustesse en production des outils ROS établis ou de l'application
constructeur.
