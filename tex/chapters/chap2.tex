...
référence \textbf{CIOT TY1251D-03195} illustrées sur la  figure~\ref{fig:robot}. Il est composé de deux sous-systèmes
...
documentée (\texttt{172.16.0.88}) s'étant révélée périmée en cours de projet.
...
s'adresse à des étudiants de 3\textsuperscript{ème} ou
4\textsuperscript{ème} année ayant des bases en réseaux, programmation et
robotique. Il est prévu sur une durée de trois à quatre mois, structuré en
...
Conception, développement, rétro-ingénierie, rédaction du rapport \\
\hline
Encadrant académique (Dr. Sridath Tula, HESTIM) &
Suivi pédagogique, validation des objectifs et du rapport \\
\hline
...
\begin{itemize}
    ...
    \item \textbf{Contraintes organisationnelles} : durée de projet limitée à
    trois-quatre mois ; étudiant unique sur le projet ; encadrement académique
    périodique.
