...
robot. Les besoins fonctionnels retenus sont présentés dans le tableau
\ref{tab:besoins_fonctionnels}.

\begin{table}[H]
\centering
\caption{Besoins fonctionnels du système CYBEL}
...
de son état de navigation, des données LiDAR, des visiteurs détectés et des
...
Déclenchement d'annonces vocales, diffusion de messages d'accueil,
commandes vocales et affichage d'informations destinées aux visiteurs. \\
\hline
...
utilisabilité. Les besoins non fonctionnels identifiés sont présentés dans le
tableau \ref{tab:besoins_non_fonctionnels}.

\begin{table}[H]
\centering
\caption{Besoins non fonctionnels du système CYBEL}
...
\hline
Performance &
Mise à jour rapide des informations afin d'assurer une supervision efficace
...
\hline
Maintenabilité &
Architecture modulaire facilitant l'évolution, la réutilisation et la
maintenance du système. \\
\hline
Sécurité &
Possibilité d'annuler rapidement les commandes critiques et protection contre
les comportements indésirables du robot. \\
\hline
Ergonomie &
Interfaces intuitives et adaptées aussi bien aux opérateurs qu'aux visiteurs. \\
\hline
\end{tabular}
\end{table}
