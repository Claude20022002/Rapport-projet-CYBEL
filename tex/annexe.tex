...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{captures_ecran/Capture1.png}
    \caption{Ancienne carte SLAM du laboratoire de l'interface opérateur}
    \label{fig:annexe_carte}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{captures_ecran/Capture2.png}
    \caption{Terminal vérification de connectivité et génération de clé SSH}
...
\begin{figure}[H]
    ...
    \caption{Dashboard opérateur - mode robot réel}
...
\begin{figure}[H]
    ...
    \caption{Panneau visite guidée - page Visite}
...
\begin{lstlisting}[style=terminal, language=bash, caption={Commandes PC (PowerShell)}, basicstyle=\ttfamily\small, breaklines=true, xleftmargin=0.05\textwidth, xrightmargin=0.05\textwidth]
# Verification reseau
ping 10.42.0.1
...
\begin{lstlisting}[style=terminal, language=bash, caption={Commandes Termux (tablette)}, basicstyle=\ttfamily\small, breaklines=true, xleftmargin=0.05\textwidth, xrightmargin=0.05\textwidth]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{diagramme/to-2026-06-29-203519.png}
    \caption{Topologie réseau du robot}
