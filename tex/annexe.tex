...
\begin{lstlisting}[style=terminal, language=bash, caption={Commandes PC (PowerShell)}, basicstyle=\ttfamily\footnotesize, breaklines=true, xleftmargin=0.05\textwidth, xrightmargin=0.05\textwidth]
ping 10.42.0.1
...
\begin{lstlisting}[style=terminal, language=bash, caption={Commandes Termux (tablette)}, basicstyle=\ttfamily\footnotesize, breaklines=true, xleftmargin=0.05\textwidth, xrightmargin=0.05\textwidth]
cd ~/cybel/scripts/termux && ./stop_cybel.sh && ./start_cybel.sh
