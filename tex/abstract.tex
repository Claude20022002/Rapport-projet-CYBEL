...
internship (PFA), aims to design an independent control and interaction platform for a CIOT
...
topics and services via \texttt{rosbridge}/\texttt{rosapi}, and systematic verification of the
